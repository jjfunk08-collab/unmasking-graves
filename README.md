...
src/
  ...
  components/             Hero, StatBand, Symptoms, Impact, TreatmentGap, etc.
  lib/                    symptoms, references, stories (illustrative composites)
```
...
- **Brand:** Dark Navy (`#002A61`) dominant, Bright Green (`#58BD2B`) as accent
  only, per Biohaven brand guidelines.
