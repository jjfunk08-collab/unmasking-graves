    ...
    <>
      <section className="bg-navy text-white">
        <div className="container-wide py-16 md:py-20">
          <p className="eyebrow text-sky">Community voices</p>
      ...
      <section className="bg-paper">
        <div className="container-wide py-14 md:py-20">
          ...
          <div className="mt-14 rounded-3xl bg-navy p-8 text-center text-white md:p-12">
            ...
            <Link
              href="/share"
              className="mt-6 inline-flex items-center justify-center rounded-full bg-sky px-7 py-3.5 text-base font-semibold text-navy-900 transition-colors hover:bg-sky-600"
            >
              Share your story
            </Link>
          </div>
