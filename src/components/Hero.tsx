  ...
  return (
    <section className="relative overflow-hidden bg-navy text-white">
      ...
      <div className="container-wide relative py-20 md:py-28 lg:py-32">
        <p className="eyebrow animate-rise text-green">A public health awareness campaign</p>

        <h1 className="mt-5 max-w-4xl text-4xl font-medium leading-[1.05] sm:text-5xl md:text-6xl lg:text-7xl">
          <span className="relative inline-block">
            <span className="animate-veil-lift italic text-green">Unmasking</span>
          </span>{" "}
        ...
        <div className="mt-9 flex animate-rise flex-col gap-3 [animation-delay:440ms] sm:flex-row sm:items-center">
          <Link
            href="/share"
            className="inline-flex items-center justify-center rounded-full bg-green px-7 py-3.5 text-base font-semibold text-navy-900 transition-transform hover:scale-[1.02] hover:bg-green-600"
          >
            Share your story
          </Link>
          <Link
        ...
        <p className="mt-14 max-w-xl animate-rise border-l-2 border-green pl-5 text-lg font-medium leading-snug text-white [animation-delay:560ms]">
